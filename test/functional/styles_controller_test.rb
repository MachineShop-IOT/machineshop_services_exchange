...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { link_color: @style.link_color, link_hover_color: @style.link_hover_color }
    end
  ...
  test "should update style" do
    put :update, id: @style, style: { link_color: @style.link_color, link_hover_color: @style.link_hover_color }
    assert_redirected_to style_path(assigns(:style))
  end
